...
- [**Electronic Store Template KIT**](https://demosites.royal-elementor-addons.com/estore-v1/?ref=rea-wpo-pp-details-tab)
- [**Woo Shop Template KIT**](https://demosites.royal-elementor-addons.com/wooshop-v1/?ref=rea-wpo-pp-details-tab)
- [**Fashion Template KIT**](https://demosites.royal-elementor-addons.com/fashion-v1/?ref=rea-wpo-pp-details-tab)
- [**Grocery Store Template KIT**](https://demosites.royal-elementor-addons.com/grocery-store-v1/?ref=rea-wpo-pp-details-tab)
- [**Furniture Store Template KIT**](https://demosites.royal-elementor-addons.com/furniture-shop-v1/?ref=rea-wpo-pp-details-tab)
- [**Food Delivery Template KIT**](https://demosites.royal-elementor-addons.com/woo-food-v1/?ref=rea-wpo-pp-details-tab)
...
[Post Grid - Post Slider - Post Carousel](https://royal-elementor-addons.com/elementor-grid-widget-examples/?ref=rea-wpo-pp-details-tab#filter:category-portfolio-grid) - A free Elementor Post Grid Widget. This elementor widget is the #1 Post Grid builder widget for the Elementor Page builder. Words can't be enough, just check it out! 
This widget could be used as a recent posts slider, post carousel, FitRows grid, masonry grid (Pro), portfolio grid, list style grid, filtrable grid if you will enable isotope filters, media grid for video project showcase and more. This grid is the best solution for WordPress blog posts or custom post types. Comes with the following options: multicolumns, numbered pagination, random post display option, load more button, infinite scroll (Pro), likes (Pro), sharing (Pro), custom fields (Pro), lightbox, linkable filters (deep linking), custom icons for filters, grid filters (live filters with isotope). No other elementor plugins are offering similar elementor addons with unique grid builder. Most advanced and most customizable post grid for elementor.

== 2. Elementor Woocommerce Grid ==

[WooCommerce Product Grid - Product Slider - Product Carousel](https://royal-elementor-addons.com/elementor-grid-widget-examples/?ref=rea-wpo-pp-details-tab#filter:category-woo-grid) - A free Elementor WooCommerce Grid Widget. This widget is the #1 WooCommerce Grid builder widget for the Elementor Page builder. Words can't be enough, just check it out! Could be used as elementor product carousel, product slider, product list, product category grid, category carousel, category slider, filtrable grid to display wooCommerce products and much more. Addon comes with the following options: multicolumn, numbered pagination, load more button, infinite scroll (Pro), product likes (Pro), product sharing (Pro), custom fields (Pro), lightbox with the gallery, linkable filters (deep linking), custom icons for filters, live grid filters (with isotope filters), sorting and much more. No other elementor plugins are offering similar elementor addons with unique woocommerce product grid builder.

== 3. Elementor Image Grid ==

[Image Grid - Image Slider - Image Carousel](https://royal-elementor-addons.com/elementor-grid-widget-examples/?ref=rea-wpo-pp-details-tab#filter:category-gallery-grid) - A free Elementor Image Grid Widget. This widget is the #1 Elementor Image Gallery builder widget for the Elementor Page builder. Words can't be enough, just check it out! Could be used as an image gallery, logo grid, image slider, image carousel, and much more. Addon comes with the following options: multicolumn post grids, numbered pagination, load more button, infinite scroll (Pro), likes (Pro), sharing (Pro), custom fields (Pro), lightbox, linkable filters (deep linking), custom icons for the filters, FitRows grid with an isotope, masonry grid (Pro), live filtrable grid (with isotope filters). No other elementor plugins are offering elementor addons with similar unique image grid builder.

== 4. Elementor Magazine Grid ==

[Magazine Grid - Slider](https://royal-elementor-addons.com/elementor-grid-widget-examples/?ref=rea-wpo-pp-details-tab#filter:category-magazine-grid) - A free Elementor Magazine Grid Widget. This widget is the #1 Magazine Grid builder widget for the Elementor Page builder. Could be used as magazine layout, newspaper layout, news grid, news slider(PRO). No other elementor plugins are offering similar magazine grid builder.

== 5. Elementor Advanced Slider ==

[Advanced Slider - Carousel](https://royal-elementor-addons.com/elementor-advanced-slider-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Image Slider Widget. This widget is the most advanced Slider widget for Elementor on WordPress org repository. Could be used as image slider, logo carousel, content slider, template slider (Pro). Creat unique looking elementor hero section with this slider. It is fully responsive and has full width and full screen options. Also, Royal Elementor Addons Pro version comes with Ken Burns effect & animated content. No other plugins are offering elementor addons with similar unique elementor slider.

== 6. Elementor Testimonial Slider ==

[Testimonial Slider](https://royal-elementor-addons.com/elementor-testimonials-slider-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Testimonial Slider Widget. This widget will showcase your customers reviews on your WordPress website. The widget offers following options: customers reviews slider, testimonials ratings (stars), company logo, clients logo or image, reviews with vintage quotes. No other elementor plugins are offering elementor addons with similar unique testimonial slider.

== 7. Elementor Nav Menu ==

[Nav Menu](https://royal-elementor-addons.com/elementor-menu-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Nav Menu Widget. This widget will make your WordPress Menu trully unique by customizing its look and feel without using code. This widget offers following options:  mobile menu customization, drop down menu setup, hamburger menu, menu hover effects and hover animations. Also, Royal Elementor Addons Pro version offers vertical menu and elementor sticky header. Most advanced & customizable responsive menu for elementor.

== 8. Elementor Onepage Navigation ==

[Onepage Navigation](https://royal-elementor-addons.com/elementor-one-page-navigation-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Onepage Navigation Widget. This widget allows you to create an amazing onepage WordPress website with just a few clicks. Can be used to create floating menu, sticky navigation menu, side menu with icons, sticky dotted buttons to scroll to any section, floating navigation bar (aka onepage scroll). Most advanced one page scroll menu for elementor.

== 9. Elementor Pricing Table ==

[Pricing Table](https://royal-elementor-addons.com/elementor-pricing-table-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Pricing Table Widget. This Elementor Pricing Comparison Table widget helps you to create an effective price comparison table with unique styling, which allows you to display not just the cost, but also the features you offer. A widget could be used as a regular pricing table & as a pricing table with a toggle button to switch from Monthly/Yearly plans. Royal Elementor Add ons Pro version offers different tooltip options for each pricing table feature, also it's possible to have more than 2 pricing plans switcher, like Monthly/Yearly/Lifetime (You can check the demo on the widget preview page).

== 10. Elementor Content Toggle ==

[Content Toggle](https://royal-elementor-addons.com/elementor-content-toggle-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Content Toggle Widget. This Elementor Content Switcher widget will showcase your key content in an interactive way. You can load Elementor Template or simply insert images and text to style it the way you want. A widget could be used as a pricing switcher as well, for example, to switch between Monthly/Yearly/Lifetime pricing plans. Royal Elementor Addons Pro version offers more than 2 toggle options - Check out the widget demo page to see all its possibilities.

== 11. Elementor Countdown Timer ==

[Countdown Timer](https://royal-elementor-addons.com/elementor-countdown-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Countdown Timer Widget. This widget allows you to display a timer that counts down to a specific time or date. A widget could be used as a black Friday sale countdown timer, to create urgency for users for your event, sales, or opt-in forms. You can set various actions after the timer expires: hide the timer, display a message, redirect or load the template. Royal Elementor Addons Pro version offers an Evergreen timer (checkout widget demo page), recurring countdown timer, and restart timer options.

== 12. Elementor Progress Bar ==

[Progress Bar](https://royal-elementor-addons.com/elementor-progress-bar-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Progress Bar Widget. This Elementor Skill Bar widget offers unique ways to style various types of stats in percentages or numbers. With this widget, you can build animated progress bars, circle progress bars, or vertical progress bars (Pro).

== 13. Elementor Tabs ==

[Tabs](https://royal-elementor-addons.com/elementor-tabs-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Tabs Widget. This Elementor Advanced Tab widget lets you display key information in an interactive manner, that attracts visitors and also saves lots of space on your WordPress webpage. The widget offers horizontal tabs, vertical tabs, tab loading animation effects, and more. Trigger tab via mouse hover or click both options are available. Also, you can have nested tabs via the elementor template loader which means you can use elementor templates as tab content.

== 14. Elementor Advanced Text ==

[Advanced Text - Fancy Text](https://royal-elementor-addons.com/elementor-advanced-text-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Animated Headline Widget. This Text animation widget lets you highlight any text with different colors, animation, and typing effects to draw your visitor's attention instantly. Available effects: typewriter effect, fancy text effect, animated text effect, highlighted text effect, text-shadow effect, text over image effect, text and image mask effect, 3d text effect, text slider, gradient text, the background image on text, text glitch effect, text long colored shadow effect, word animation effect, text skew effect, text flip vertical and horizontal effect, slide, clip, zoom, scale, circle line, underline zigzag line, curly line, cross x line, line through and many other effects. Pro Version offers extra effects and functionalities

== 15. Elementor Flip Box ==

[Flip Box](https://royal-elementor-addons.com/elementor-flip-box-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Flip Box Widget. This widget with hover box animation and call-to-action buttons will highlight your content in a great way and allows you to create stunning promo boxes and ads with CTA button functionality. The widget offers more flipping effects in the pro version and some extra functionality as well.

== 16. Elementor Promo Box ==

[Promo Box](https://royal-elementor-addons.com/elementor-promo-box-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Banner Widget. With this widget, you can create: a clickable image with some effects, a clickable image with image hover effects, add text over image, display call to action button over image, and many other options. Create a stunning sale or discount banners with CTA buttons and badges with this addon. Royal Elementor addons Pro Version offers extra effects and functionalities.

== 17. Elementor Before After Slider ==

[Before After Slider - Image comparison Slider](https://royal-elementor-addons.com/elementor-before-after-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Image comparison slider. This addon can compare two pictures with draggable or mouse hover options in horizontal and vertical(Pro) layouts. Play with some options to give a stunning look to your WordPress page with this elementor addon.

== 18. Elementor Image Hotspot ==

[Image Hotspots](https://royal-elementor-addons.com/elementor-image-hotspot-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Image Map Widget to build image hotspot maps, allows you to create an elementor hot spot image with 2x points on it. Add tooltips to icons to make it stunning and informative. Royal Elementor Addons PRO versions offer unlimited hotspot points.

== 19. Elementor Form Styler ==

[Forms](https://royal-elementor-addons.com/elementor-forms-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Forms Widget. This Form widget comes with the following options: contact form 7 elementor styler, elementor Gravity forms styler, elementor Ninja Forms styler, and elementor WPforms styler.

== 20. Elementor MailChimp Subscribe ==

[MailChimp](https://royal-elementor-addons.com/elementor-mailchimp-subscription-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Mailchimp subscribe (Newsletter) Widget. This addon helps you to collect emails from your website visitors by creating stunning email opt-in forms. Our Mailchimp Form is the best free Mailchimp integration tool for your WordPress website. Add a stunning signup form to your page and collect your subscriber's emails to create an effective email campaign. If you want to build long-term relationships with your clients this Mailchimp Elementor widget is for you. No other elementor addons are offering elementor addons with similar unique MailChimp Subscribe widgets in the free version. Most powerful elementor newsletter widget for free. Royal elementor addons PRO version offers some extended functionality for this widget.

== 21. Elementor Content Ticker ==

[Content Ticker](https://royal-elementor-addons.com/elementor-content-ticker-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor News Ticker Widget. This Elementor widget helps you showcase trending posts with unique animation effects, and will give your website a stunning look that attracts your audience's attention. Can be used to display: recent posts, hot / trending posts with a blinking effect. No other elementor plugins are offering elementor addons with similar unique content ticker widgets in the free version.

== 22. Elementor Button Widget ==

[Button](https://royal-elementor-addons.com/elementor-button-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Button Widget with button animations. This Elementor Widget helps you create conversion-friendly elementor call to action sections and comes with advanced button features like 2d animations, button animation, background animations, text animations, custom icons, gradient effects, rounded corners, background images, hover shadow, and many more. Choose from tons of different button styles and effects to make your WordPress website look outstanding.

== 23. Elementor Dual Button Widget ==

[Dual Button](https://royal-elementor-addons.com/elementor-button-widget/?ref=rea-wpo-pp-details-tab#dualbuttonsection) - A free Elementor Dual Button Widget. This Dual Button Elementor Widget will place two buttons side by side that help you create a conversion-friendly call to action sections. Comes with advanced dual button features like 2d animations, background animations, text animations, custom icons, gradient effects, rounded corners, background images, hover shadow, middle text (Pro), middle icon (Pro), and many more. Choose from tons of different button styles and effects to make your Elementor Page look outstanding. Two buttons next to each other could be a super attractive feature for your WordPress website.

== 24. Elementor Team Member Widget ==

[Team Member](https://royal-elementor-addons.com/elementor-team-member-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Team Member Widget aka profile widget. This Widget is the best & fastest way to build a team grid with elementor to introduce your team members and add credibility to your WordPress website. Addon comes with image, name, surname, job, position, social links, button, and biographic info (bio) fields. It is a great way to add company members, staff, workers, employees, or people with rich member profiles to your elementor page. With the Royal elementor addons Pro version, you can create a team member slider or team carousel. Most powerful free elementor profile widget with hover animation effects.


== 25. Elementor Google Maps Widget ==

[Google Maps](https://royal-elementor-addons.com/elementor-google-maps-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Google Maps Widget. This widget gives you full control over the configuration, with the multiple locations option you can set multiple addresses. Map Comes with a custom marker and tooltip options. Choose from different google map types: roadmap, satellite, hybrid or terrain. Show/hide controls like street view and more. Also, our addon allows you to change a color scheme with a custom skin option. No other elementor plugins are offering elementor addons with similar unique google maps widgets in the free version.

== 26. Elementor Price List Widget ==

[Price List](https://royal-elementor-addons.com/elementor-price-list-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Price Table Widget. This widget lets you create an amazing Restaurant Menu for your products very easily. It comes with lots of different styles so you can get a unique and top-notch design to make your elementor price list attractive. The price list grid allows you to create a Restaurant Price List (Restaurant Menu) which will help take advantage of your competitors. Price Catalog could be used for small businesses, spas, salons, restaurants, retail, bars, coffee shops & diners, retail stores, website designers, photographers & videographers, weddings, DJs, hosting companies, loan companies, personal fitness coaches, wedding companies, party planning venues, nail salons, beauty salons, tanning salons and more. Give a stunning look to your WordPress website with this elementor addon.

== 27. Elementor Business Hours Widget ==

[Business Hours](https://royal-elementor-addons.com/elementor-business-hours-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Business Hours Widget. This Widget offers the following options: opening times table and closing hours table. Rich elementor controls allow you to customize this widget in many ways.

== 28. Elementor Sharing Buttons ==

[Sharing Buttons](https://royal-elementor-addons.com/elementor-social-sharing-buttons-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Share Buttons Widget. This widget lets you share your pages and blog posts on any popular social media websites. Available platforms: Facebook, Twitter, Linkedin, Pinterest, Reddit, Tumblr, Digg, Xing, Stumble upon, Vkontakte, Odnoklassniki, Pocket, Skype, Whatsapp, Telegram, Delicious, Email, Print, etc... This widget has rich elementor control for styling options which lets you create a unique design for your elementor page. Royal Elementor addons pro version offers much more customization options.

== 29. Elementor Search Form ==

[Search Form](https://royal-elementor-addons.com/elementor-search-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Search Widget. This Elementor Search Form could be used as a custom post-type search, product search, woocommerce search. Multiple styling options let you customize your WordPress search bar in a unique way. In the latest version, Ajax search was added with advanced elementor controlls for maximum customiztion.

== 30. Elementor Site Logo ==

[Site Logo](https://royal-elementor-addons.com/) - A free Elementor Site Logo Widget. This widget comes with the following features: retina logo, custom mobile logo, custom logo URL, rich logo, and tagline customization options.
...
[Elementor Lottie Animation](https://royal-elementor-addons.com/elementor-lottie-animation-widget/?ref=rea-wpo-pp-details-tab) Our Elementor Lottie animation widget for Elementor gives you the ability to easily add Lottie Animations to your Elementor pages. Comes with features like reverse Lottie animation, autoplay, loop, different render types of Lottie animation like SVG or Canvas, rotate or change animation size, manipulate with animation speed, trigger animation on hover, on viewport or on scroll. Add a custom link on the Lottie animation and lots of other features. Use CSS Filters Effects to completely change Lottie's animation visual. Ability to load Lottie animation from multiple sources - Load with Custom link or Media library.

== 34. Elementor Timeline Widget ==

[Timeline Widget](https://royal-elementor-addons.com/elementor-timeline-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Timeline widget. Create your timeline chart using our timeline grid widget. Comes with horizontal (timeline slider), vertical (one-sided) & zigzag styles. Advanced styling for timeline items, content, backgrounds, etc. Can be used to create a history timeline, blog timeline, event timeline, story timeline, company timeline, post timeline, timeline slider & video timeline. The widget Layout is mobile and tablet ready. You can display your WordPress blog posts as timeline items or create your own custom timeline items. You don't need any other WordPress elementor timeline plugin because our widget has all the great features in it that no other page builder timeline has for free.

== 35. Elementor Mega Menu Widget ==

[Mega Menu Widget](https://royal-elementor-addons.com/elementor-mega-menu-widget/?ref=rea-wpo-pp-details-tab) - A free Elementor Mega Menu Widget. Create eye-catching megamenu with our Elementor mega menu widget. Use any elementor widget(s) to display in megamnu. We have developed a Page list widget, especially for megamenu which helps quickly display all pages in megamenu items. Also, Custom page badges can be set with megamenu page list widget. Our widget supports Horizontal and Vertical megamenu layouts. Some of the PRO features: Load Megamenu SubMenu Items with Ajax for maximum page speed scores, Add Icons and Badges to mega menu items, Set Submenu width to Automatically Fit to Section width where Elementor mega menu widget is placed, Display Mobile Menu sub-items as Mega Menu Item or WordPress Default Sub Item, Mobile Menu Off-Canvas Layout, Megamenu SubMenu Width option, Advanced Link Hover Effects: Slide, Grow, Drop, Mega menu SubMenu Entrance Advanced Effects, Mobile Menu Button Custom Text option. You don't need any other mega menu plugin because our widgets have all the great features it which no other plugin offers.

== Elementor Template Kits in Details: ==

[Nature Elementor Templates Kit](https://demosites.royal-elementor-addons.com/nature-v1/?ref=rea-wpo-pp-details-tab) - One of the Royal Addons elementor templates. Elementor Templates Kit can be installed via plugin backend and most of it's content builded with our elementor addons. Navigate to Royal elementor Addons WP menu dashboard > Templates Kits and search for Nature elementor template. Used advanced slider, testimonial, post timeline, menu, logo, back to top, button, promo box known as image effects, post grid, contact form, Header footer builder and Elemnetor pop up builder. All elementor page templates kits and royal elementor addons widgets are responsive ready. This Kit is only created with elementor and royal addons which is the one of the best elementor addons on the market.

[Digital Agency Templates Kit](https://demosites.royal-elementor-addons.com/digitalagency-v1/?ref=rea-wpo-pp-details-tab) - One of the most popular Royal Addons elementor templates. Elementor Templates Kit can be installed via plugin backend and most of it's content builded with our elementor addons. Navigate to Royal elementor Addons WP menu dashboard > Templates Kits and search for Digital Agency elementor template. Used advanced text, flip box, content toggle, post timeline, menu, logo, back to top, button, post grid, contact form, Header footer builder and Elementor pop up builder, phone call, progress bar aka skill bar, team member, mailchimp, pricing table, google maps elementor widgets. All elementor page templates kits and royal elementor addons widgets are responsive ready. This Kit is only created with elementor and royal addons which is the one of the best elementor addons on the market.

[It Technology 1 Templates Kit](https://demosites.royal-elementor-addons.com/ittech-v1/?ref=rea-wpo-pp-details-tab) - One of the most requested Royal Addons elementor templates. Elementor Templates Kit can be installed via plugin backend and most of it's content builded with our elementor addons. Navigate to Royal elementor Addons WP menu dashboard > Templates Kits and search for It Technology elementor template. Used advanced text, testimonial, pricing table, progress bar, team member, flip box, circle bar, testimonial, mailchimps subscription, lottie animation, contact form, google maps, menu, logo, back to top, phone call, Elementor pop up builder widgets. All elementor page templates kits and royal elementor addons widgets are responsive ready. This Kit is only created with elementor and royal addons which is the one of the best elementor addons on the market.

[Construction Templates Kit](https://demosites.royal-elementor-addons.com/construction-v1/?ref=rea-wpo-pp-details-tab) - One of the Royal Addons elementor templates. Elementor Templates Kit can be installed via plugin backend and most of it's content builded with our elementor addons. Navigate to Royal elementor Addons WP menu dashboard > Templates Kits and search for Construction elementor template. Used advanced text, button, countdown, progress bar, post timeline, team member, post grid, circle bar, testimonial, flip box, gallery, mailchimp subscription, advanced slider, pricing table, pricing list, contact form, google maps, menu, logo, back to top, phone call, Elementor pop up builder widgets. All elementor page templates kits and royal elementor addons widgets are responsive ready. This Kit is only created with elementor and royal addons which is the one of the best elementor addons on the market.

[Architecture Templates Kit](https://demosites.royal-elementor-addons.com/architecture-v1/?ref=rea-wpo-pp-details-tab) - One of the Royal Addons elementor templates. Elementor Templates Kit can be installed via plugin backend and most of it's content builded with our elementor addons. Navigate to Royal elementor Addons WP menu dashboard > Templates Kits and search for Architecture elementor template. Used advanced slider, advanced slider with ken burn effect, image hotspot, pricing table, content toggle, testimonial carousel, mailchimp subscription, social sharing, team member, open hours aka business, content ticker aka News Ticker, promo box, dual button, post grid, pricing table, countdown, advanced tabs,  contact form, google maps, menu, logo, back to top, phone call, Elementor pop up builder widgets. All elementor page templates kits and royal elementor addons widgets are responsive ready. This Kit is only created with elementor and royal addons which is the one of the best elementor addons on the market.

[It Technology 2 Templates Kit](https://demosites.royal-elementor-addons.com/ittech-v2/?ref=rea-wpo-pp-details-tab) - One of the Royal Addons elementor templates. Elementor Templates Kit can be installed via plugin backend and most of it's content builded with our elementor addons. Navigate to Royal elementor Addons WP menu dashboard > Templates Kits and search for It Technology elementor template. Used advanced text, flip box, promo box, button, team member, content timeline, pricing table, post grid, testimonial, progress bar, content toggle, pricing table, contact form, google maps, menu, logo, back to top, phone call, pop up, Elementor pop up builder widgets. All elementor page templates kits and royal elementor addons widgets are responsive ready. This Kit is only created with elementor and royal addons which is the one of the best elementor addons on the market.

[Drone Templates Kit](https://demosites.royal-elementor-addons.com/drone-v1/?ref=rea-wpo-pp-details-tab) - One of the Royal Addons elementor templates. Elementor Templates Kit can be installed via plugin backend and most of it's content builded with our elementor addons. Navigate to Royal elementor Addons WP menu dashboard > Templates Kits and search for drone elementor template. Used advanced text, button, image hotspot, blog post, promotional box, testimonial, team member, business hours, flip box, promo box, skill bar, content toggle, pricing table, countdown, gallery grid, post grid, advanced slider, contact form, google maps, menu, logo, back to top, phone call, pop up, Elementor pop up builder widgets. All elementor page templates kits and royal elementor addons widgets are responsive ready. This Kit is only created with elementor and royal addons which is the one of the best elementor addons on the market.

[Cybersecurity Templates Kit](https://demosites.royal-elementor-addons.com/cybersecurity-v1/?ref=rea-wpo-pp-details-tab) - One of the Royal Addons elementor templates. Elementor Templates Kit can be installed via plugin backend and most of it's content builded with our elementor addons. Navigate to Royal elementor Addons WP menu dashboard > Templates Kits and search for drone elementor template. Used content ticker, advanced text, timeline, flip box, advanced slider, post grid, pricing table, advanced tabs, testimonial slider, team member, skill bar, team member, contact form, google maps, menu, logo, back to top, phone call, pop up, Elementor pop up builder widgets. All elementor page templates kits and royal elementor addons widgets are responsive ready. This Kit is only created with elementor and royal addons which is the one of the best elementor addons on the market.

[Medical Templates Kit](https://demosites.royal-elementor-addons.com/medical-v1/?ref=rea-wpo-pp-details-tab) - One of the Royal Addons elementor templates. Elementor Templates Kit can be installed via plugin backend and most of it's content builded with our elementor addons. Navigate to Royal elementor Addons WP menu dashboard > Templates Kits and search for Medical elementor template. Used Advanced text, flip box, circle bar, team member, testimonial, timeline, blog post grid, pricing table, advanced slider, promo box, progress bar, contact form, google maps, menu, logo, back to top, phone call, pop up, Elementor pop up builder widgets. Elementor sticky header extention. All elementor page templates kits and royal elementor addons widgets are responsive ready. This Kit is only created with elementor and royal addons which is the one of the best elementor addons on the market. Latest Update: Added Elementor Mega Menu widget in the header. With Elementor Mega Menu widget you can display/use any elementor widget one your site, Like the Sale product Grid, featured product grid, tabs and many other elementor widgets. In the pro Version, you can display Icons and badges for Elementor Mega Menu widget. Also, You can load elementor mega menu items with ajax for maximum page speed score results.

**Elementor Woocommerce Builder demos**

[Woo Shop](https://demosites.royal-elementor-addons.com/wooshop-v1/?ref=rea-wpo-pp-details-tab) - One of the Royal Addons elementor templates wich is builded with Woocommerce elementor builder. Elementor Templates Kit can be installed via plugin backend and most of it's content builded with our elementor addons. Navigate to Royal elementor Addons WP menu dashboard > Templates Kits and search for **Woocommerce** elementor template. Used elementor woocommerce widgets like: elementor woocommerce add to cart widget, cart widget, checkout widget, minicart widget, product price widget, product media widget, product tabs widget, product rating widget, product meta widget, product sale badge widget, product notice widget, product excerpt widget, products in Stock widget, additional info widget. Other regular widdgets used: advanced slider, promo box, progress bar, contact form, google maps, menu, logo, back to top. All elementor page templates kits and royal elementor addons widgets are responsive ready. This Kit is only created with royal addons which is the one of the best elementor addons on the market. Latest Update: Added Mega Menu widget in the header and Elementor Ajax Live search widget. With Mega Menu widget you can display/use any elementor widget in your shop, Like the Sale product grid, featured product grid, tabs and many other elementor widgets. In the Pro Version, you can display Icons and badges for Mega Menu widget. Also, You can load elementor mega menu items with ajax for maximum page speed score results.

[Fashion](https://demosites.royal-elementor-addons.com/fashion-v1/?ref=rea-wpo-pp-details-tab) - One of the Royal Addons elementor PRO templates which is built with Woocommerce elementor builder. Elementor Templates Kit can be installed via plugin backend and most of its content built with our elementor addons. Navigate to Royal elementor Addons WP menu dashboard > Templates Kits and search for **Woocommerce** elementor template. Used elementor woocommerce widgets like: elementor woocommerce category grid, elementor woocommerce add to cart widget, cart widget, checkout widget, minicart widget, product price widget, product media widget, product tabs widget, product rating widget, product meta widget, product sale badge widget, product notice widget, product excerpt widget, products in the Stock widget, additional info widget. Other regular widdgets used: advanced slider, promo box, progress bar, contact form, google maps, menu, logo, back to top. All elementor page templates kits and royal elementor addons widgets are responsive ready. This Kit is only created with royal addons which is the one of the best elementor addons on the market. Latest Update: Added Mega Menu widget in the header and Elementor Ajax Live search widget. With Mega Menu widget you can display/use any elementor widget in your shop, Like the Sale product grid, featured product grid, tabs and many other elementor widgets. In the Pro Version, you can display Icons and badges for Mega Menu widget. Also, You can load elementor mega menu items with ajax for maximum page speed score results - this option is only supported in the pro version.
